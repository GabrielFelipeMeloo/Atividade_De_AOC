...
var _mul = Module['_mul'] = makeInvalidEarlyAccess('_mul');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['mul'] != 'undefined', 'missing Wasm export: mul');
  _mul = Module['_mul'] = createExportWrapper('mul', 2);
